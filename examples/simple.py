...
from omniqubo import Omniqubo  # noqa: E40
from omniqubo.sampleset import dimod_import  # noqa: E40
...
omniqubo.to_hobo(100.0)  # note to_qubo should be used here, but quadratize is required
